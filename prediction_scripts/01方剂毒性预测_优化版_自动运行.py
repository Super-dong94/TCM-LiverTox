...
# 而是整合为：
#
# - `06_high_toxic_chemicals_master.csv`：高危成分主表；
...
# 这里保留 Formula / Herb / ChemicalName / Symbol，方便后续解释“哪个高危成分来自哪味中药、可能作用于哪些靶标”。
target_df = (
...
# 补充方剂和药材来源信息
if SMILES_COL in high_toxic_df.columns:
    source_cols = compact_metadata_cols(high_toxic_df, [SMILES_COL, "Formula.Chinese.name", "Herb.Chinese.name"])
